...
from onyx.server.regulation_analysis.api import router as regulation_analysis_router
...
def get_application() -> FastAPI:
    ...
    include_router_with_global_prefix_prepended(application, regulation_analysis_router)
